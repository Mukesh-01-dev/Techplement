...
for (let i = 1; i <= 5; i++) {
  ...
  document.getElementById(`quote${i}`).innerHTML = quotes[index].quote;
  document.getElementById(`author${i}`).innerHTML = quotes[index].author;
}
}
displayQuote();
...
function randomQuote() {
  ...
  randomAuthor.innerHTML = quotes[index].author;
}
randomQuote();

function copyTexRandomQuote() {
  navigator.clipboard.writeText(randomquote.innerHTML + "--" + randomAuthor.innerHTML);
}

// function copyAuthorQuote() {
//   const copyText = document.getElementById("authorQuote").innerHTML;
//   navigator.clipboard.writeText(authorQuote.innerHTML);
// }

// const authorNameInput = document.getElementById("authorName");
// const authorQuote = document.getElementById("authorQuote");
// const authorAuthor = document.getElementById("authorAuthor");
// function searchAuthor() {
//   for (let q of quotes) {
//     if (q.author == authorNameInput.value.toString()) {
//       authorQuote.innerHTML = q.quote;
//       authorAuthor.innerHTML = q.author;
//     } else {
//       authorQuote.innerHTML = "Author not found (or) Type error"
//     }
//   }
// }
